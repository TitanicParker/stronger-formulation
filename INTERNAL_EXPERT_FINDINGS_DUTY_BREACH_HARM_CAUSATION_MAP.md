# Internal Counsel Map — Plain-Language Version
...
> **Reasonable Neurology should have worked out whether the neurological disorder was contributing to the painful feet before treating the feet as separate, or should have kept that question actively open.**
...
> **What did it do with that finding in relation to the pain?**

---

# 4. Possible neuropathy breach
...
# 6. Podiatry handoff breach

Podiatry was appropriate.

The issue is not the referral itself.
...
# 8. Later continuation breach

Later Neurology records foot movement, sensitivity, morning difficulty, severe pain, possible OFF dystonia, OFF-related pain / shuffling, toe curling and Sinemet-related pain benefit.

The record is mixed and includes contrary patient-reported evidence.
...
The case is not about harm from words on paper.

Potential harm is any extra:

- pain;
- difficulty standing or walking;
- recurrent loading injury;
- loss of function;
- loss of work / ordinary life;
...
Do not argue that Neurology caused the original foot pain.

The pain existed long before treatment.
...
# 12. Institutional case

Do not say “the hospital knew everything.”

Ask:

> **Who knew enough, at each date, to ask the next obvious question?**

And:

> **Who was supposed to put the pieces together?**

The institutional case is strongest when tied to actual information and opportunity.

---

# 13. Best-case legal chain

## Duty

> **Investigate whether the neurological disorder was contributing to the painful feet, or keep the question open.**
...
> **Extra pain, loading injury, loss of mobility / function and psychological distress.**

## Causation

> **Better care would probably have changed the explanation, treatment or follow-up early enough to reduce some of that suffering.**

---

# 14. The questions each expert answer must feed

For every proposed breach:
...
# 15. Things not to overclaim

Do not say:

- all foot pain was dystonia;
- Sinemet proves the original cause;
- Podiatry was inappropriate;
- nothing was reconsidered for eight years;
- the medication created the original pain;
- every undocumented examination was not performed;
...
# 16. Strongest plain-language formulations

> **They saw the abnormal walk. They knew the feet hurt. Where is the examination showing why the two were separate?**

> **The tablets they prescribed for the neurological condition changed what happened in the feet.**
...
> **If they had done the right thing then, what suffering would probably have been avoided?**